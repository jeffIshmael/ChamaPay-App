...
INSERT INTO "new_Chama" ("adminId", "amount", "blockchainId", "canJoin", "createdAt", "cycle", "cycleTime", "id", "maxNo", "name", "payDate", "payOutOrder", "promoCode", "round", "slug", "startDate", "started", "type") SELECT "adminId", "amount", "blockchainId", "canJoin", "createdAt", "cycle", "cycleTime", "id", "maxNo", "name", "payDate", "payOutOrder", "promoCode", "round", "slug", "startDate", "started", "type" FROM "Chama";
DROP TABLE "Chama";
