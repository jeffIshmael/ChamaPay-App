...
import { Bell, Plus, PiggyBank, Wallet } from "lucide-react-native";
...
const tabs = [
  ...
  { name: "save-earn", label: "Save & Earn", icon: PiggyBank },
  { name: "create-chama", label: "Create", icon: Plus, isCenter: true },
  { name: "notifications", label: "Notifications", icon: Bell },
  { name: "wallet/index", label: "Wallet", icon: Wallet },
];

const TabItem = ({ tab, idx, state, navigation, unReadNotificationCount }: any) => {
...
export default function BottomNavigation({ state, navigation }: BottomTabBarProps) {
  ...
  if (!isRouteInTabs || keyboardVisible) return null;
