...
Alert.alert("Error", "Failed to save secure PIN");
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            <View style={{ flex: 1 }} className="px-6 pt-12">
                {/* Header */}
                ...
                <View className="flex-1 justify-center mt-4 items-center">
    ...
    return (
        <View className="flex-row flex-wrap justify-center gap-6 mt-8 max-w-[310px]">
            {keys.map((key) => {
                ...
                if (key === "arrow-slot") {
                    return (
                        <View key={key} className="w-[70px] h-[70px] items-center justify-center mt-4">
